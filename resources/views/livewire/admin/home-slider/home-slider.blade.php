<div class="grid grid-cols-1 gap-6 p-3 ">
    ...
    <div class="panel">
        ...
        ">
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                        <div class="">
                            <label for="customBrandName">نام اسلاید
                                <span class=" text-danger">*</span>
                            </label>
                            <input wire:model="name" id="customBrandName" type="text"
                                placeholder="نام اسلاید را وارد کنید" class="form-input">
                    ...
                    @else
                        <button type="submit" class="btn btn-primary !mt-6">ثبت اسلاید</button>
                    @endif
                </div>
            </form>
        </div>
    ...
    <div class="panel">
        <div class="flex items-center justify-between mb-5">
            <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                <h5 class="text-lg font-semibold dark:text-white-light">اسلاید ها</h5>
                {{-- search box --}}
                ...
                <div class="mt-3 table-responsive">
                    ...
                    <div class="panel">
                        <div class="flex flex-col justify-center w-full">
                            {{ $slides->links('admin.layouts.admin_pagination') }}
                        </div>
                    </div>
                </div>
        </div>
