    ...
    <div class="panel">
        ...
        <div class="flex items-center justify-between mb-5">
            <div class="grid grid-cols-1 gap-5">
                <h5 class="text-lg font-semibold dark:text-white-light">لیست برندهای حذف شده</h5>
            </div>
            ...
            <a href="{{ route('admin.brands.list') }}" type="button" class="btn btn-info">
                                ...
                                <tr>
                                    ...
                                    <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                                        <button type="button" x-tooltip="Restore"
                                            wire:click="$dispatch('confirmRestore',{ brand_id : {{ $brand->id }} })">
...
<script>
    document.addEventListener('livewire:init', () => {
        ...
        Livewire.on('deleteConfirm', (event) => {
            ...
            hardDeleteBrand(brand_id);
        });

        Livewire.on('confirmRestore', (event) => {
            const brand_id = event.brand_id;
            restoreBrand(brand_id);
        });
    });
</script>
