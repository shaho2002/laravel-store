<div class="grid grid-cols-1 gap-6 p-3 ">
    ...
    <div class="panel">
        ...
        <div class="flex items-center justify-between mb-5">
            <h5 class="text-lg font-semibold dark:text-white-light">
                {{ $this->brandIndex ? 'ویرایش برند' : 'افزودن برند جدید' }}</h5>
        </div>
        <div class="mb-5">
        ...
        ">
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                        <div class="">
                            <label for="customBrandName">نام برند
                                <span class=" text-danger">*</span>
                            </label>
                            <input wire:model="brandName" id="customBrandName" type="text"
                                placeholder="نام برند را وارد کنید" class="form-input">
                        ...
                        <div class="">
                            <label for="brandSlug">نام مستعار</label>
                            <input wire:model="brandSlug" id="brandSlug" type="text"
                        ...
                        <div class="">
                            <label for="image">عکس برند</label>
                    ...
                    @else
                        <button type="submit" class="btn btn-primary !mt-6">ثبت برند</button>
                    @endif
                </div>
            </form>
        </div>
    ...
    <div class="panel">
        <div class="flex items-center justify-between mb-5">
            <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                <h5 class="text-lg font-semibold dark:text-white-light">لیست برندها</h5>
                {{-- search box --}}
            ...
            {{-- trashed --}}
            <a href="{{ route('admin.trashed.brands.list') }}" type="button" class="btn btn-danger">
                ...
                <div class="mt-3 table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                                        <button type="button" x-tooltip="Edit"
                                            wire:click="editBrand({{ $brand->id }})" @click="scrollToTop()">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <button type="button" x-tooltip="Delete"
                                            wire:click="$dispatch('deleteConfirm',{ brand_id : {{ $brand->id }} })">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <div class="panel">
                        <div class="flex flex-col justify-center w-full">
                            {{ $brands->links('admin.layouts.admin_pagination') }}
                        </div>
                    </div>
                </div>
        </div>
