    ...
    <div class="panel">
        ...
        <div class="flex items-center justify-between mb-5">
            <div class="grid grid-cols-1 gap-5">
                <h5 class="text-lg font-semibold dark:text-white-light">لیست محصولات حذف شده</h5>
            </div>
            {{-- search box --}}
            ...
            <a href="{{ Route('admin.products.list') }}" type="button" class="btn btn-info">
                                ...
                                <tr>
                                    ...
                                    <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                                        <button type="button" x-tooltip="Restore"
                                            wire:click="$dispatch('confirmRestore',{ product_id : {{ $product->id }} })">
