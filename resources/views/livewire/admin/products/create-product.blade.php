<div class="grid grid-cols-1 gap-6 p-3">
    ...
    <div class="panel">
        ...
        <div class="flex items-center justify-between mb-5">
            <h5 class="text-lg font-semibold dark:text-white-light">افزودن محصول جدید</h5>
        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <table class="min-w-full border border-collapse border-gray-300">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="p-2 border border-gray-300"><strong>نام انگلیسی محصول:</strong>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-2 border border-gray-300">{{ number_format($price) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-2 border border-gray-300">
                                            @if ($image)
                                                <dive class="flex justify-center">
