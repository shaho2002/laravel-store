<div class="grid grid-cols-1 gap-6 p-3 ">
    ...
    <div class="panel">
        ...
        <div class="flex items-center justify-between mb-5">
            ...
            <a href="{{ route('admin.categories.list') }}" type="button" class="btn btn-info">
                                ...
                                <tr>
                                    ...
                                    <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                                        <button type="button" x-tooltip="ویرایش"
                                            wire:click="$dispatch('confirmRestore',{ category_id : {{ $category->id }} })">
...
<script>
    document.addEventListener('livewire:init', () => {
        ...
        Livewire.on('deleteConfirm', (event) => {
            ...
            hardDeleteCategory(category_id);
        });

        Livewire.on('confirmRestore', (event) => {
            const category_id = event.category_id;
            restoreCategory(category_id);
        });
    });
</script>
