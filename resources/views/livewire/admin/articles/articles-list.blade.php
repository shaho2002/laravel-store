...
<div class="grid grid-cols-1 gap-6 p-3 ">
    ...
    <div class="panel">
        <div class="flex items-center justify-between mb-5">
            <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                ...
                <form>
                    <select wire:model="selectedCategory" wire:change="setCategoryFilter"
                        ...
                        <option value='allCategories'>همه مقالات</option>
            ...
            <a href="{{ route('admin.create.article') }}" type="button" class="btn btn-success btn-sm ">
            ...
            <a href="{{ route('admin.trashed.article') }}" class="btn btn-danger btn-sm">
                        ...
                        <tbody>
                            @foreach ($articles as $index => $article)
                                <tr>
                                    ...
                                    @elseif($article->status === 'notActive')
