    ...
    <div class="panel">
        ...
        <div class="flex items-center justify-between mb-5">
            <div class="grid grid-cols-1 gap-5 ">
                <h5 class="text-lg font-semibold dark:text-white-light">لیست رنگ‌های حذف شده</h5>
            </div>
            {{-- search box --}}
            ...
            <a href="{{ route('admin.colors.list') }}" type="button" class="btn btn-info">
                                ...
                                <tr>
                                    ...
                                    <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                                        <button type="button" x-tooltip="Restore"
                                            wire:click="$dispatch('confirmRestore',{ color_id : {{ $color->id }} })">
...
<script>
    document.addEventListener('livewire:init', () => {
        ...
        Livewire.on('deleteConfirm', (event) => {
            ...
            hardDeleteColor(color_id);
        });

        Livewire.on('confirmRestore', (event) => {
            const color_id = event.color_id;
            restoreColor(color_id);
        });
    });
</script>