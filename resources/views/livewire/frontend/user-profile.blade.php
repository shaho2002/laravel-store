<main class="container relative">
    ...
    <div class="flex flex-col mt-10 lg:flex-row gap-x-8">
        ...
        <div class="lg:w-3/4">
            ...
            <div
                class="grid grid-cols-12 gap-4 mt-5 child:col-span-12 lg:mt-0 md:child:col-span-4 child:rounded-lg child:bg-white child:dark:bg-gray-800 child:w-full child:flex child:shadow child:p-4">
                <div class="flex items-center gap-x-4">
                    <svg class="text-blue-500 size-9">
                        <use href="#wallet" />
                    </svg>
                ...
                <div class="flex items-center gap-x-4">
                    ...
                    <div class="flex flex-col gap-y-1">
                        <h2 class="font-DanaDemiBold">تعداد سفارش‌ها</h2>
                        <p class="text-gray-500">{{ $this->orders_count }}</p>
                    </div>
                </div>
                <div class="flex items-center gap-x-4">
                    <svg class="text-blue-500 size-9">
            ...
            <div class="flex flex-col p-4 mt-5 bg-white rounded-lg shadow dark:bg-gray-800">
                <span class="flex items-center gap-x-2">
                    <img src="{{url('frontend/images/svg/status-delivered.svg')}}" class="w-10" alt="">
                    <h2 class="text-lg font-DanaMedium">سفارش های اخیر:</h2>
                </span>
