<main class="relative">
    ...
    <!-- AMAZING SLIDER -->
    <section class="mx-4 mt-20 lg:container">
        <div class="relative w-full p-4 bg-blue-500 h-80 rounded-xl dark:bg-blue-700">
            <!-- AmazingSlider products Slider -->
            <div class="w-full swiper AmazingSlider rounded-xl">
                <div class="swiper-wrapper">
                    <!-- item -->
                    ...
                    <div class="swiper-slide small-card group">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="product-card_price-wrapper">
                                <!-- Price -->
                                <div class="justify-between small-card_price">
                                    <span class="pt-1">70%</span>
                                    <h4 class="flex items-center text-lg gap-x-1">130,000,000 <p
            ...
            <button
                class="absolute z-10 border border-gray-200 slider-navigate_btn right-1 top-36 dark:border-gray-700 AmazingSlider-prev-slide">
                <svg class="-rotate-90 size-6">
                    <use href="#chevron" />
                </svg>
            </button>
            <button
                class="absolute z-10 border border-gray-200 slider-navigate_btn left-1 top-36 dark:border-gray-700 AmazingSlider-next-slide">
                <svg class="rotate-90 size-6">
                    <use href="#chevron" />
                </svg>
            </button>
