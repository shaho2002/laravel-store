...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ url('admin-panel/favicon.png') }}" />
...
<body x-data="main" class="relative overflow-x-hidden text-sm antialiased font-normal"
    ...
    <script src="{{ url('admin-panel/js/alpine-collaspe.min.js') }}"></script>
    <script src="{{ url('admin-panel/js/alpine-persist.min.js') }}"></script>
    <script defer src="{{ url('admin-panel/js/alpine-ui.min.js') }}"></script>
    <script defer src="{{ url('admin-panel/js/alpine-focus.min.js') }}"></script>
    <script defer src="{{ url('admin-panel/js/alpine.min.js') }}"></script>
