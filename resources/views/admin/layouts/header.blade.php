        ...
        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
            <div class="flex items-center justify-between horizontal-logo ltr:mr-2 rtl:ml-2 lg:hidden">
                <a href="index.html" class="flex items-center main-logo shrink-0">
                    <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="{{ url('admin-panel/images/logo.svg') }}"
                        alt="image" />
                </a>
            ...
            <div x-data="header"
                ...
                <div class="sm:ltr:mr-auto sm:rtl:ml-auto">
                     تاریخ امروز :   
                    {{ Hekmatinasser\Verta\Verta::now()->formatJalaliDate() }}
                </div>
                <div>
                ...
                <div class="dropdown" x-data="dropdown" @click.outside="open = false">
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                                    ...
                                    <div class="grid rounded place-content-center">
                                        <div class="relative w-12 h-12">
                                            <img class="object-cover w-12 h-12 rounded-full"
                                                :src="`{{ url('admin-panel/images/${notification.profile}') }}`"
                                                alt="image" />
                                            <span
                        ...
                        <template x-if="notifications.length">
                            <li>
                                <div class="p-4">
                                    <button class="block w-full btn btn-primary btn-small" @click="toggle">همه
                                        نوتیفیکیشن ها را بخوانید</button>
                                </div>
                            </li>
                        </template>
                        <template x-if="!notifications.length">
                ...
                <div class="flex-shrink-0 dropdown" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="relative group" @click="toggle()">
                        <span><img class="object-cover rounded-full h-9 w-9 saturate-50 group-hover:saturate-100"
                                src="{{ url('admin-panel/images/user-profile.jpeg') }}" alt="image" /></span>
                    </a>
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                            ...
                            <div class="flex items-center px-4 py-4">
                                <div class="flex-none">
                                    <img class="object-cover w-10 h-10 rounded-md"
                                        src="{{ url('admin-panel/images/user-profile.jpeg') }}" alt="image" />
                                </div>
